...
new Deck({
	...
	controller: true,
	getTooltip: ({ object }: PickingInfo<ZipCode>) =>
...
const polygons = [
	...
	{
		positions: [
			-122.4, 37.7, 0, -122.4, 37.8, 0, -122.5, 37.8, 0, -122.5, 37.7, 0, -122.4, 37.7, 0, -122.45,
			37.73, 0, -122.47, 37.76, 0, -122.47, 37.71, 0, -122.45, 37.73, 0
		],
		holeIndices: [15]
	}
];
